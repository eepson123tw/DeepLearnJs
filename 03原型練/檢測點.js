
{
  ...
  */
  const linkProto = (parentObj) => {
    ...
    if(parentObj.__proto__ !== Object.prototype) return console.error( 'parent type error');
    
    parentObj.__proto__ = {...Object.prototype,
      unlink:function(childObj){
      childObj.__proto__ = Object.prototype
    }}
